...
class CertificateManager:
    ...
    def __init__(self, session):
        ...
        self.cert_client = self.session.client('acm', region_name='us-east-1')

    def cert_matches(self, cert_arn, domain_name):
        """Return True if cert matches domain_name."""
        cert_details = self.cert_client.describe_certificate(
    ...
    def find_matching_cert(self, domain_name):
        ...
        paginator = self.cert_client.get_paginator('list_certificates')
